...
//The important point is, if we have sorted suffixes according to first 2i characters,
//then we can sort suffixes according to first 2i+1 characters in O(nLogn) time using a nLogn sorting algorithm like Merge Sort.
