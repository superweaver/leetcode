...
/*
   The Subsystem can accept requests either from facade or client directly.
...
/*
   ...
   (may not be able to access full functionality of all subsystem)
   (You can think Facade as a pre-configured logic to operate subsystems to provide simple interface for client)
   The Facade delegates the client requests to the appropriate objects within subsystem.
...
/*
   The facade's methods are convient shortcuts to the sophisticated
   functionality of the subsystems. However, clients get only to a fraction of
   a subsystem capablities.
   */
string Operation() {
...
/*
   ...
   the client might not even know about the existence of the subsystem. This approach lets you keep the complexity under control.
   */
